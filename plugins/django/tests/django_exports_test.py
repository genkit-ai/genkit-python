...
from genkit.plugins.django.handler import RequestData
...
class TestDjangoModuleExports:
    ...
    def test_handler_module_importable(self) -> None:
        ...
        from genkit.plugins.django import handler
    ...
    def test_genkit_django_handler_signature(self) -> None:
        ...
        from genkit.plugins.django.handler import genkit_django_handler
    ...
    def test_package_name(self) -> None:
        ...
        from genkit.plugins.django import package_name

        assert package_name() == 'genkit.plugins.django'
